                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Bạn có chắc đang muốn xóa <span style="color: blue">${user.getName()}</span>?
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-"><a href="/user?action=delete&id=${user.getId()}">Xóa</a></button>
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><a href="/user">Hủy bỏ</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
