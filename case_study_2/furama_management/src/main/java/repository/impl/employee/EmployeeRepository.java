...
public class EmployeeRepository implements IEmployeeRepository {
    ...
    private static String SEARCH = "call sp_search_employee(?,?,?);";
    ...
    public List<Employee> search(String nameSearch, String nameAddress, String phoneNumberSearch) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                int educationDegreeId = resultSet.getInt("education_degree_id");
                int divisionId = resultSet.getInt("division_id");
                employeeListSearch.add(new Employee(id, name, dateOfBirth, idCard, salary, phoneNumber, email, address, positionId, educationDegreeId, divisionId));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
